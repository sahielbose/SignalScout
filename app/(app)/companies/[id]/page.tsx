    ...
    <>
      ...
      <div className="mx-auto grid max-w-5xl gap-5 p-6 lg:grid-cols-3">
        ...
        <div className="lg:col-span-2">
          ...
          {timeline.length === 0 ? (
            <Card className="p-8 text-center text-sm text-muted-foreground">No signals recorded for this company yet.</Card>
          ) : (
            <div className="space-y-2">
              {timeline.map((s) => {
                ...
                return (
                  <Card key={s.id} className={cn('flex items-start gap-3 border-l-2 p-3', style.border)}>
