      ...
      <div className="mt-2 space-y-1.5">
        {matches.map(([n, r], i) => (
          <div
            ...
            className="flex animate-fade-up items-center gap-2.5 rounded-lg border border-border px-3 py-2 transition-all duration-200 hover:-translate-y-0.5 hover:border-[hsl(var(--accent))] hover:shadow-md"
          >
