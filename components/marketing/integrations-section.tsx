        ...
        <div className="mt-10 grid gap-5 md:grid-cols-3">
          {cards.map((c, i) => (
            <div
              ...
              className="animate-fade-up rounded-xl border border-[hsl(var(--ink-section-border))] bg-[hsl(var(--ink-section-card))] p-6 transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md"
            >
