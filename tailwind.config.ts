  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        ...
        'fade-down': 'fade-down 0.5s cubic-bezier(0.21, 0.6, 0.35, 1) both',
        'scale-in': 'scale-in 0.35s cubic-bezier(0.21, 0.6, 0.35, 1) both',
        pop: 'pop 0.22s ease-out',
        'slide-in-right': 'slide-in-right 0.4s cubic-bezier(0.21, 0.6, 0.35, 1) both',
      },
    },
  },
